...
public class Exhibits extends ActionBarActivity {
	...
	public void openExhibits2(View view)
	{
		Intent intent = new Intent(this, Exhibits2.class);
		startActivity(intent);
	}
	...
	public static class PlaceholderFragment extends Fragment {
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container,
			...
			View rootView = inflater.inflate(R.layout.fragment_exhibits,
					container, false);
			return rootView;
		}
	}
